...
/**
 * Inky will be similar to Inky is this version... This class extends Sprite and uses class PacMan to acquire 
...
public class Inky extends Sprite {
	 ...
	 * @param wall
	 */
	public Inky (PacMan pacman, PacWall wall) {
		try {
			img = ImageIO.read(new File("Inky.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		xAxis = 260;
	...
	/**
	 * With the Graphics2D object, it will paint Inky at its location with size 20 by 20 (width and height)
	 * @param g2d
	 */
	...
	/**
	 * This method controls the behavior of Inky. Inky will head straight for
	 ...
	 * clear, it will go that side. It returns true if Inky hit PacMan.
	 * @return
	 */
